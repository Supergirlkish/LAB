...
void UpdateMYbuttons()
	{
		...
		WorkingMode= GPIOPinRead(0x40025000,GPIO_PIN_4);
		
		if (WorkingMode !=0) Mybuttons.SW1=0;
		else Mybuttons.SW1 = 1;

		WorkingMode= GPIOPinRead(0x40025000,GPIO_PIN_0);
		...
		
	{
		...
		GPIOPinTypeGPIOOutput(0x40025000, GPIO_PIN_1);
		GPIOPinTypeGPIOOutput(0x40025000, GPIO_PIN_2);
    GPIOPinTypeGPIOOutput(0x40025000, GPIO_PIN_3);
	...
	{		
		 ...
		 volatile uint32_t ui32Loop;
			...
			GPIOPinWrite (0x40025000, GPIO_PIN_1, 0XF );
			 
       for(ui32Loop = 0; ui32Loop < 1000000; ui32Loop++)
	     {
			 }
			 GPIOPinWrite(0x40025000, GPIO_PIN_1, 0x0);
       ...
       for(ui32Loop = 0; ui32Loop < 1000000; ui32Loop++)
       {
			...
			GPIOPinWrite (0x40025000, GPIO_PIN_2, 0XF );
			 
       for(ui32Loop = 0; ui32Loop < 1000000; ui32Loop++)		
        {
        } 	
	
		  GPIOPinWrite(0x40025000, GPIO_PIN_2, 0x0);
        ...
        for(ui32Loop = 0; ui32Loop < 1000000; ui32Loop++)
        {
			...
			GPIOPinWrite (0x40025000, GPIO_PIN_3, 0XF );
      
        for(ui32Loop = 0; ui32Loop < 1000000; ui32Loop++)
        {
        }
																										         
      GPIOPinWrite(0x40025000, GPIO_PIN_3, 0x0);
